...
public class Tienda {
	...
	public boolean anhade(Vendedor nuevoVendedor) throws IOException { //WMC+1
		if (buscaVendedor(nuevoVendedor.getId()) != null)
			return false;
	...
	private void leeSeccion(Scanner in, String tipoVendedor, LinkedList<Vendedor> lista) {
		Vendedor ven = null;
